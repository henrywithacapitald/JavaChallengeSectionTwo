public class MathsOperations {
    public static void main(String[] args) {
        ...
        long starsInMilkeyWay = 2500000000L;
        long starsInAndromeda = 1000000000000L;

        double testScore = 6.7;
        double bonusMark = 2.5;

        System.out.println("Fred and George collected " + (bagOfSweets2 + bagOfSweets1) + " sweets" );
        System.out.println("There are " + (starsInAndromeda + starsInMilkeyWay) + " stars in the Milky Way and Andromeda galaxies.");
        ...
        System.out.println("The Andromeda Galaxy has " + (starsInAndromeda - starsInMilkeyWay) +" more stars than the Milky Way");
        ...
        System.out.println("Andromeda has "+(starsInAndromeda / starsInMilkeyWay)+" times more stars");
